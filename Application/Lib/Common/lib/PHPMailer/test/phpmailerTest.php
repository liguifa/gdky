...
require_once '../../../../../Admin/Controller/Lib/Common/lib/PHPMailer/PHPMailerAutoload.php';
...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        if (file_exists('../../../../../Admin/Controller/Lib/Common/lib/PHPMailer/test/testbootstrap.php')) {
            include '../../../../../Admin/Controller/Lib/Common/lib/PHPMailer/test/testbootstrap.php'; //Overrides go in here
        }
...
EOT;
    ...
    public function testIcal()
    {
        ...
        $this->Mail->isHTML(true);
        $this->buildBody();
        require_once '../../../../../Admin/Controller/Lib/Common/lib/PHPMailer/extras/EasyPeasyICS.php';
