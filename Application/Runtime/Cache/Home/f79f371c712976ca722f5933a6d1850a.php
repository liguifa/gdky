				...
				<div id="content_content_left">
					...
					<?php if(is_array($technologys)): $i = 0; $__LIST__ = $technologys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tech): $mod = ($i % 2 );++$i;?><li class="content_content_left_div_ul_li">
							<div class="content_content_left_body_content">
								<h3><a href="<?php echo U('Home/Index/newContent/html/'.$tech['technology_Url']);?>" target="_bank"><?php echo ($tech["technology_Title"]); ?></a></h3>
								<p><?php echo ($tech["technology_Brief"]); ?></p>
							</div>
							<ul>
								<li><a href="#"><?php echo ($tech["user_Username"]); ?></a> 发布于 <?php echo ($tech["technology_PublicTime"]); ?></li>
