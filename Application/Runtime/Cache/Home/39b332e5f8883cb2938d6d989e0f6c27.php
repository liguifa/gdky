				...
				<div id="content_content_right">
					<ul>
						<li>
							<div>
							<h4>开源技术</h4>
							<?php if(is_array($technologys)): $i = 0; $__LIST__ = $technologys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tech): $mod = ($i % 2 );++$i;?><p><a href="<?php echo U('Home/Index/newContent/html/'.$tech['technology_Url']);?>"><?php echo ($tech["technology_Title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
						</li>
						<li>
							<div>
							<h4>开源项目</h4>
							<?php if(is_array($projects)): $i = 0; $__LIST__ = $projects;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$project): $mod = ($i % 2 );++$i;?><p><a href="<?php echo U('Home/Index/newContent/html/'.$project['technology_Url']);?>"><?php echo ($project["technology_Title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
						</li>
						<li>
							<div>
							<h4>代码分享</h4>
							<?php if(is_array($shares)): $i = 0; $__LIST__ = $shares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$share): $mod = ($i % 2 );++$i;?><p><a href="<?php echo U('Home/Index/newContent/html/'.$share['technology_Url']);?>"><?php echo ($share["technology_Title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
						</li>
						<li>
							<div>
							<h4>热门帖子</h4>
							<?php if(is_array($posts)): $i = 0; $__LIST__ = $posts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$post): $mod = ($i % 2 );++$i;?><p><a href="<?php echo U('/Home/Index/postContent/pId/'.$post['post_Id'].'/page/1');?>"><?php echo ($post["post_Title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
						</li>
						<li>
							<div>
							<h4>最新问题</h4>
							<?php if(is_array($questions)): $i = 0; $__LIST__ = $questions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$question): $mod = ($i % 2 );++$i;?><p><a href="<?php echo U('/Home/Index/postContent/pId/'.$question['post_Id'].'/page/1');?>"><?php echo ($question["post_Title"]); ?></a></p><?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
						</li>
						<li>
							<div>
