			...
			<div id="content_content">
				<div id="content_content_left">
					...
					<ul class="content_content_left_div_ul">
						...
						<li class="px type px_active" data-id="0"><a href="../../../type/0/pageIndex/<?php echo ($pageIndex); ?>.html">全部</a></li>
						<?php if(is_array($hotForum)): $i = 0; $__LIST__ = $hotForum;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$forum): $mod = ($i % 2 );++$i;?><li class="px type" data-id="<?php echo ($forum["forum_Id"]); ?>"><a href="../../../type/<?php echo ($forum["forum_Id"]); ?>/pageIndex/<?php echo ($pageIndex); ?>.html"><?php echo ($forum["forum_Name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
